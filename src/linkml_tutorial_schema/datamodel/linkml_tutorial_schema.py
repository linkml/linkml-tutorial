...
# Generation date: 2022-09-15T16:50:55
...
class Organization(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKML_TUTORIAL_SCHEMA.Organization
...
class Event(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKML_TUTORIAL_SCHEMA.Event
...
class MedicalEvent(Event):
    ...
    class_model_uri: ClassVar[URIRef] = LINKML_TUTORIAL_SCHEMA.MedicalEvent
...
class ForProfit(Organization):
    ...
    class_model_uri: ClassVar[URIRef] = LINKML_TUTORIAL_SCHEMA.ForProfit
...
class NonProfit(Organization):
    ...
    class_model_uri: ClassVar[URIRef] = LINKML_TUTORIAL_SCHEMA.NonProfit
...
slots.age = Slot(uri=TEMP.age, name="age", curie=TEMP.curie('age'),
                   model_uri=LINKML_TUTORIAL_SCHEMA.age, domain=None, range=Optional[str])

slots.gender = Slot(uri=TEMP.gender, name="gender", curie=TEMP.curie('gender'),
                   model_uri=LINKML_TUTORIAL_SCHEMA.gender, domain=None, range=Optional[str])
...
slots.has_medical_history = Slot(uri=TEMP.has_medical_history, name="has medical history", curie=TEMP.curie('has_medical_history'),
                   model_uri=LINKML_TUTORIAL_SCHEMA.has_medical_history, domain=None, range=Optional[str])
...
slots.Person_name = Slot(uri=TEMP.name, name="Person_name", curie=TEMP.curie('name'),
                   model_uri=LINKML_TUTORIAL_SCHEMA.Person_name, domain=Person, range=str)

slots.Person_age = Slot(uri=TEMP.age, name="Person_age", curie=TEMP.curie('age'),
                   model_uri=LINKML_TUTORIAL_SCHEMA.Person_age, domain=Person, range=Optional[Decimal])

slots.Person_gender = Slot(uri=TEMP.gender, name="Person_gender", curie=TEMP.curie('gender'),
                   model_uri=LINKML_TUTORIAL_SCHEMA.Person_gender, domain=Person, range=Optional[Decimal])
...
slots.Person_has_medical_history = Slot(uri=TEMP.has_medical_history, name="Person_has medical history", curie=TEMP.curie('has_medical_history'),
                   model_uri=LINKML_TUTORIAL_SCHEMA.Person_has_medical_history, domain=Person, range=Optional[Union[Union[dict, "MedicalEvent"], List[Union[dict, "MedicalEvent"]]]])

slots.Organization_name = Slot(uri=TEMP.name, name="Organization_name", curie=TEMP.curie('name'),
                   model_uri=LINKML_TUTORIAL_SCHEMA.Organization_name, domain=Organization, range=str)